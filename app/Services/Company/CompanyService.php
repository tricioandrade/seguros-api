...
class CompanyService
{
     ...
     */
    public function getAll(): CompanyModel|Collection
    {
     ...
     *
     * @param int $id
     * @return CompanyModel|Collection
     * @throws UnauthorizedException
     */
    public function getById(int $id): CompanyModel|Collection
    {
        if (!$this->isAdmin()) throw new UnauthorizedException();
     ...
     * @throws UnauthorizedException
     */
    public function update(array $attributes, int $id): CompanyModel|Collection
    {
        if (!$this->isAdmin()) throw new UnauthorizedException();
